...
| runner-steps-4-5 | 04-05 | 3 | QA-01/QA-02 | T-4-18/T-4-21 | relative pointers only; canonical immediate-reject; tag in report | container-e2e | `npm run qa:run -- npx vitest run --config vitest.qa.config.ts gate-e2e` | ❌ W0 (04-05 T2) | ⬜ pending |
